...
function getBotResponse(userInput, callback) {
    ...
    var data = {message: userInput, 
        ...
        qaHistory: qaHistory, 
        curOrg: "Bellevue School District",
        websiteTitleSuffix: "| Bellevue School District"};
    ...
    fetch('https://api.mindflow.ai:443/api/chroma', {
        method: 'POST',
        headers: {
