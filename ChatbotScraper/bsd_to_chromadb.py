...
extracted_path = os.environ.get("CHATBOT_PATH") + '/Data/bsd_extracted'
chroma_table_path = os.environ.get("CHATBOT_PATH") + '/Data/bsd_db'
...
collection = client.get_or_create_collection(
    name="bsd_db", embedding_function=embedding)
...
def extract_pdf_text(pdf_filename):
    with open(pdf_filename, 'rb') as pdf_file:
        ...
        pdf_text = ''
        pdf_title = "Bellevue School District"
